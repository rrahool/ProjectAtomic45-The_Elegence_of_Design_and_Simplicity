...
$objBirthView= new\App\WareHouse\BirthdateStore();
$objBirthView->setdata($_GET);
$BirthView = $objBirthView-> view();
?>
    <!doctype html>
    <html lang="en">
<head>
...
<div class="container view">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><?php echo $BirthView->id ?></td>
            <?php $birthStr = $BirthView->birth; ?>
            <td><?php echo date("d-M-Y",strtotime($birthStr))?></td>
            <td class="act"><a href='edit.php?id=<?php echo $BirthView->id ?>' class='btn btn-primary btn-block'><span class="glyphicon glyphicon-pencil"></span></a></td>
        </tr>
    </table>
</div>
</body>
