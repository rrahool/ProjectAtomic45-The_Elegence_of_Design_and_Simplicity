...
<div class="opt-nav">
    <ul>
        ...
        <li><a href="../City/City.php">Add City</a></li>
        <li><a href="../Email/Email.php">Add Email</a></li>
        <li><a href="../Gender/Gender.php">Add Gender</a></li>
        <li><a href="../Hobbies/Hobbies.php">Add Hobbies</a></li>
        <li><a href="../ProfilePic/ProPic.php">Add Picture</a></li>
        <li><a href="../Summary/Summary.php">Add Summary</a></li>
    </ul>
</div>
