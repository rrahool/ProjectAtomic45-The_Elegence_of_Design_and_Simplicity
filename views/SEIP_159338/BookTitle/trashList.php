...
$objTrashlist= new \App\WareHouse\BookStore();
...
<table cellpadding="0" cellspacing="0">
    ...
    foreach ($Data2view as $Trash){
        ?>
        <tr>
            <td><label><input type='checkbox' class='checkbox' name='mark[]' value='<?php echo $Trash->id ?>'><span class="chk_lbl"></span></label></label></td>
            <td><?php echo $serial ?></td>
            <td><?php echo $Trash->id;?></td>
            <td><?php echo $Trash->bookTitle;?></td>
            <td><?php echo $Trash->authorName;?></td>
            <td class="act">
